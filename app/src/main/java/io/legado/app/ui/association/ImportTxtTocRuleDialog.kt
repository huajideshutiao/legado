...
class ImportTxtTocRuleDialog() : BaseComposeDialogFragment() {
    ...
    override fun Content() {
        ...
        LaunchedEffect(Unit) {
            viewModel.errorLiveData.observe(this@ImportTxtTocRuleDialog) {
                loading = false
                error = it
            }
            viewModel.successLiveData.observe(this@ImportTxtTocRuleDialog) {
                loading = false
        ...
        ImportListScaffold(
            ...
            itemState = {
                ...
                when {
                    local == null -> "新增"
                    viewModel.allSources[it] != local -> "更新"
                    else -> "已有"
                }
            },
