...
fun WelcomeConfigScreen(
    ...
    AppTheme {
        ...
        val titleEnable = rememberString("enable_welcome")
        val summaryEnable = rememberString("enable_welcome_summary")
        val titleShowTime = rememberString("welcome_show_time")
        val titleShowText = rememberString("show_welcome_text")
        val summaryShowText = rememberString("welcome_text")
        val titleShowIcon = rememberString("show_icon")
        val summaryShowIcon = rememberString("show_default_book_icon")
        val labelDay = rememberString("day")
        val labelNight = rememberString("night")
        val titleBgImage = rememberString("background_image")
        PreferenceScreen {
            switchPreference(
