...
val sharedStringTable: Map<String, String> = mapOf(
            ...
            "desktop_install_mode_not_portable" to "[legado-desktop] install mode = %s (portable.root not set, 下游走 ~/.legado)",
            ...
            "desktop_upload_not_supported" to "桌面端暂不支持上传书籍到远程",
            "desktop_download_local_not_supported" to "桌面端暂不支持下载到本地",
            ...
            "video_load_chapter_list_error_log" to "桌面视频获取章节列表出错\n%s",
            "video_load_chapter_content_error_log" to "桌面视频获取章节内容出错\n%s",
            "video_no_resource_url" to "未获取到资源链接",
            "video_parse_source_json_error_log" to "桌面视频解析源JSON出错\n%s",
            "video_load_chapter_error_log" to "桌面视频加载章节出错\n%s",
            "video_save_read_progress_error_log" to "桌面视频保存阅读进度出错\n%s",
            "video_save_play_position_error_log" to "桌面视频保存播放位置出错\n%s",
            "vlc_init_failed" to "VLC 初始化失败: %s\n请确保已安装 VLC media player (https://www.videolan.org/)",
            "video_vlcj_init_failed_log" to "桌面视频 vlcj 初始化失败\n%s",
            "video_release_vlcj_error_log" to "桌面视频释放 vlcj 出错\n%s",
            "video_play_error_vlcj_event" to "桌面视频播放出错 (vlcj error 事件)",
            "video_memory_m3u8_not_supported_log" to "桌面视频暂不支持内存 m3u8 (vlcj TODO: 需写临时文件 + file:// 协议)",
            "video_load_error_log" to "桌面视频加载出错\n%s",
            "video_play_pause_error_log" to "桌面视频播放/暂停出错\n%s",
            "video_seek_error_log" to "桌面视频 seek 出错\n%s",
            "video_speed_error_log" to "桌面视频倍速出错\n%s",
            "video_play_error_log" to "桌面视频播放出错: %s",
