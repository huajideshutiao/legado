 ...
 * 由 JsEncodeUtilsAndroid (app 层) 多继承注入, jvmAndAndroidTest `object : JsEncodeUtilsDefaults {}` 可复用。
 *
 ...
 * - app 层 [JsEncodeUtilsAndroid] : JsEncodeUtilsDefaults (替代原 `: JsEncodeUtils`)
