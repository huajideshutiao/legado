        ...
        private fun buildCall(): Call {
            ...
            clientBuilder.addNetworkInterceptor { chain ->
                ...
                if (enableCookieJar) {
                    ...
                    // app 端 CookieManager 经 CookieJarBridgeHolder 注入; 未注册时退化为移除 header 的原请求
                    request1 = CookieJarBridgeHolder.get()?.loadRequest(requestBuilder.build())
                ...
                if (enableCookieJar) {
                    CookieJarBridgeHolder.get()?.saveResponse(networkResponse)
                }
                networkResponse
            }
