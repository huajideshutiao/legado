...
/**
 * FileUtils 的纯 JDK 部分下沉 (shared jvmAndAndroidMain)。
 *
 * app 端 [FileUtils] 的对应函数转发到本 object, 保持调用方 import 路径不变。
 * shared 内部 (如 FileDocIo androidMain actual) 直接调用本 object。
 */
object FileUtilsBase {
