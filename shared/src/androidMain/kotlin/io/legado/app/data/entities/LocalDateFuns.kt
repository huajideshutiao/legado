...
/**
 * Android actual: 桥接 java.time.LocalDate 静态方法与属性到 commonMain top-level expect fun。
 * LocalDate 类型本身经 actual typealias 直接等于 java.time.LocalDate (minSdk 26 已含 java.time)。
 */
