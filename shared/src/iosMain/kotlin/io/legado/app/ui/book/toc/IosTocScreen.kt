 ...
 *   exportBookmark/exportBookmarkMd 简化为复制 JSON/Markdown 到剪贴板 (iOS 端无文件保存面板)
 ...
 *
 * 15 个回调中, exportBookmark/exportBookmarkMd 简化为复制到剪贴板 (iOS 端无文件保存面板),
 * toggleSplitLongChapter 暂为 no-op (依赖 FileBook, iOS 端未下沉), 其余与 desktop 一致。
 */
