...
/**
 * [ZipFileWrapper] 工厂跨平台接口 (commonMain 下沉版)。
 *
 ...
 * - **iOS / 鸿蒙**: `NativeZipFileWrapperFactory` 用 commonMain [RemoteZipCore]
 *   解析本地 cbz (纯 Kotlin zip 读取, 无 JVM 依赖), 在各自 ProviderRegistry 注入。
 *
...
interface ZipFileWrapperFactory {
     ...
     *   为 null 表示无附加资源。实现内部应保证 [AutoCloseable.close] 幂等。
     */
     ...
     * - 本地 .cbz / .zip: [LocalZipWrapper] / NativeZipFileWrapper
     * - 其他本地压缩包: LocalArchiveWrapper (app 端专属, 其他端无)
     *
