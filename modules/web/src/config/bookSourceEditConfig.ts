    ...
    children: [
      {
        ...
        id: 'reviewUrl',
        type: 'String',
        hint: '评论列表URL，支持{{paragraphIndex}}占位符：-1=书籍级, 0=章节级, >0=段评级',
      },
      {
        title: '列表规则',
        namespace: 'ruleReview',
        id: 'reviewList',
        type: 'String',
        hint: '评论列表节点选择器 (规则结果为List<Element>)',
      },
      {
        title: '段评数规则',
        namespace: 'ruleReview',
        id: 'reviewCountRule',
        type: 'String',
        hint: '整章段评数规则，返回 {paragraphIndex: count}，仅 paragraphIndex>0 生效',
      },
      {
        title: '段评ID',
        namespace: 'ruleReview',
      ...
      },
      {
        ...
        id: 'avatarRule',
        type: 'String',
        hint: '段评发布者头像 (规则结果为String类型的url)',
      },
      {
        title: '发布者',
        namespace: 'ruleReview',
      ...
      },
      {
        ...
        id: 'voteUpCountRule',
        type: 'String',
        hint: '点赞数 (规则结果为Int/String)',
      },
      {
        title: '是否已点赞',
        namespace: 'ruleReview',
        id: 'voteUpSelectedRule',
        type: 'String',
        hint: '是否已点赞（当前登录用户），结果按 Boolean 解析',
      },
      {
        title: '是否已点踩',
        namespace: 'ruleReview',
        id: 'voteDownSelectedRule',
        type: 'String',
        hint: '是否已点踩（当前登录用户），结果按 Boolean 解析',
      },
      {
        title: '回复数',
        namespace: 'ruleReview',
      ...
      },
      {
        ...
        id: 'totalCountRule',
        type: 'String',
        hint: '段评总数规则（请求级，result 为整页响应 body）',
      },
      {
        title: '回复列表URL',
        namespace: 'ruleReview',
        id: 'replyListUrl',
        type: 'String',
        hint: '回复列表URL规则（JS），变量：paragraphIndex / reviewId',
      },
      {
        title: '翻页规则',
        namespace: 'ruleReview',
        id: 'hasMoreRule',
        type: 'String',
        hint: '段评是否有下一页（请求级，result 为整页响应 body）',
      },
      {
        title: '点赞规则',
        namespace: 'ruleReview',
        id: 'voteUpRule',
        type: 'String',
        hint: '点赞规则（JS），变量：paragraphIndex / reviewId / selected',
      },
      {
        title: '点踩规则',
        namespace: 'ruleReview',
        id: 'voteDownRule',
        type: 'String',
        hint: '点踩规则（JS），变量：paragraphIndex / reviewId / selected',
      },
      {
        title: '回复规则',
        namespace: 'ruleReview',
        id: 'replyRule',
        type: 'String',
        hint: '回复评论规则（JS），变量：paragraphIndex / content / reviewId',
      },
      {
        title: '删除规则',
        namespace: 'ruleReview',
